...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(View root) {
        super(root);
        this.root = root;
        title = (TextView) root.findViewById(R.id.recycher_text);
        checkBox = (CheckBox) root.findViewById(R.id.recycher_cb);
    }
}
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View root = LayoutInflater.from(parent.getContext()).inflate(R.layout.checkboxlayout, parent, false);
